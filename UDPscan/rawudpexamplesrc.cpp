...
#define MAX_PACKET            1024         // maximum datagram size
...
//void ValidateArgs(int argc, char **argv)
{
	...
	//gAddressFamily = AF_INET;
	//gSrcAddress = "10.26.30.193";
	//gSrcPort = "59486";

	//gDestAddress = "123.206.80.223";
	//gDestPort = "8888";

	//gSendCount = 4;

	//gMessage = "test string";
...
int main(int argc, char **argv)
{
	...
	//ValidateArgs();
	gAddressFamily = AF_INET;
	gSrcAddress = "127.0.0.1";
	gSrcPort = "59486";

	gDestAddress = "127.0.0.1";
	gDestPort = "8888";
